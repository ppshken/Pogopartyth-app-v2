...
try {
  ...
  if ($antiSpam->fetch()) {
    $db->rollBack();
    jsonResponse(false, null, 'คุณจะสร้างห้องได้อีกครั้ง ภายใน 2 นาที', 429);
  }
  ...
  if ($qActive->fetch()) {
    $db->rollBack();
    jsonResponse(false, null, 'คุณมีห้องอยู่แล้ว กรุณายกเลิกห้องเดิมก่อนดำเนินการอีกครั้ง', 409);
  }
